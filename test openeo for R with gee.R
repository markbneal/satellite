# test openeo for R with gee example
...
collection_viewer(x="COPERNICUS/S2")
...
#user = "group7" # doesn't work
user = "group27" # as provided by email request, the pathway suggested by website
pwd = "test123"

# connect  to the back-end and login either via explicit call of login, or use your credentials in the connect function
gee = connect(host = "https://earthengine.openeo.org",user = user,password = pwd, login_type = "basic") #doesn't appear to work
#gee = connect(host = "https://earthengine.openeo.org",user = user,password = pwd) # appears to work, but still doesn't create job below
